 ...
 * 2.1 添加 Push 监听器
 */
+ (void)addPushListener:(id<TIMPushListener>)listener NS_EXTENSION_UNAVAILABLE_IOS("This API is not supported in App Extension");

/**
 * 2.2. 移除 Push 监听器
 */
+ (void)removePushListener:(id<TIMPushListener>)listener NS_EXTENSION_UNAVAILABLE_IOS("This API is not supported in App Extension");
